...
TEXT = {
    "it": {
        ...
        "home_seo": "Rapido Tools raccoglie strumenti online gratuiti per le piccole esigenze di tutti i giorni: calcolare l'età o i giorni tra due date, contare i giorni lavorativi con le festività, sapere quanti giorni mancano a Natale o a una data qualsiasi, calcolare le ore lavorate e sommare ore e minuti, contare le parole di un testo, scrivere un numero in lettere, risolvere una proporzione o adattare le dosi di una ricetta, calcolare la media ponderata e il voto di laurea, la tredicesima o le ferie di una colf, il passo di corsa, generare una password sicura, calcolare percentuali, sconti, IVA e rata del mutuo, convertire unità di misura, ridimensionare e comprimere le foto o creare un codice QR. Ogni strumento ha una breve guida con esempi e risposte alle domande più comuni. Il sito è in italiano e in inglese e cresce nel tempo: se ti manca uno strumento, <a href=\"contatti/\">scrivici</a>.",
    ...
    "en": {
        ...
        "home_seo": "Rapido Tools is a collection of free online tools for everyday needs: work out your age or the days between two dates, count working days with Italian holidays, count down to Christmas or any date, add up hours worked, count the words in a text, spell a number in words, solve a proportion or scale a recipe, work out a weighted grade average or your running pace, generate a strong password, calculate percentages, discounts, VAT and loan payments, convert units, resize and compress photos or create a QR code. Every tool comes with a short guide, examples and answers to common questions. The site is available in English and Italian and keeps growing: if a tool you need is missing, <a href=\"contact/\">let us know</a>.",
