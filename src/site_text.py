...
TEXT = {
    "it": {
        ...
        "home_meta": "Calcolatori, convertitori e strumenti online gratuiti, senza registrazione e senza pubblicità invadente. Tutto funziona nel tuo browser: date, testo, numeri, salute, soldi e immagini.",
        ...
        "home_seo": "Rapido Tools raccoglie strumenti online gratuiti per le piccole esigenze di tutti i giorni: calcolare l'età o i giorni tra due date, contare le parole di un testo, generare una password sicura, calcolare percentuali, sconti, IVA e rata del mutuo, convertire unità di misura, ridimensionare e comprimere le foto o creare un codice QR. Ogni strumento ha una breve guida con esempi e risposte alle domande più comuni. Il sito è in italiano e in inglese e cresce nel tempo: se ti manca uno strumento, <a href=\"contatti/\">scrivici</a>.",
    ...
    "en": {
        ...
        "home_meta": "Free online calculators, converters and utilities, no sign-up and no intrusive ads. Everything runs in your browser: dates, text, numbers, health, money and images.",
...
CAT_ORDER = ["date", "text", "numbers", "health", "money", "images"]
